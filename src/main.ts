...
let getSelection, setSelection, deleteSelectedText, deleteText, insertText;
let replaceSelectedText, surroundSelectedText, extractSelectedText, collapseSelection;

// Trio of isHost* functions taken from Peter Michaux's article:
// http://peter.michaux.ca/articles/feature-detection-state-of-the-art-browser-scripting
function isHostMethod(object, property) {
    var t = typeof object[property];
    return t === "function" || (!!(t == "object" && object[property])) || String(t) === "unknown";
}
...
(() => {
    ...
    if (isHostProperty(testTextArea, "selectionStart") && isHostProperty(testTextArea, "selectionEnd")) {
        ...
        isHostMethod((<any>document).selection, "createRange")) {
...
export function injectJQuery($: JQueryStatic): void {
    $.fn.extend({
